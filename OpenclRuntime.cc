...
// #define MACE_LATENCY_LOGGER(LEVEL, INFO) \
//     std::cout << __FILE__ << "," << __LINE__ << ":" << INFO << std::endl;
#define MACE_LATENCY_LOGGER(...)
...
OpenCLLibrary::OpenCLLibrary() {
  ...
  // If close the OpenCL library, the static OpenCLExecutor destructor may fail.
